    ...
    <div className="p-6">
      ...
      {vendors.length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center text-gray-500">
          ...
          <p className="text-lg">No pending vendors found.</p>
        </div>
      ) : (
            ...
            <div className="px-6 py-4 border-t border-gray-100 bg-white flex flex-col sm:flex-row justify-between items-center gap-4">
               <div className="flex-1 w-full relative">
                 <input 
                    ...
                    className="w-full text-sm border-gray-200 rounded-lg p-2.5 outline-none focus:ring-2 focus:ring-red-200 border bg-gray-50"
                 />
               </div>
